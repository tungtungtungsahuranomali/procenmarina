...
if(isset($_POST['submit'])){
    ...
    $dataadmin = "INSERT INTO user set level = '$level', username = '$usernameadmin', password = '$passwordadmin'";
    $connectdataadmin = mysqli_query($koneksi, $dataadmin);
  ...
  if($usersession){
    ?>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <h2 class="mb-4">User Add<Title></Title></h2>
       

        <form method="POST">

        <div class="mb-3 w-75">
          <label for="exampleFormControlInput1" class="form-label">Pilih Level Access</label>
              <select name="level">
                  <option value="super">Superadmin</option>
                  <option value="marketing">foc</option>
              </select>
        </div>

        <div class="mb-3 w-75">
          <label for="exampleFormControlInput2" class="form-label">Username</label>
          <input type="text" class="form-control" name="usernameadmin" id="exampleFormControlInput2" placeholder="Masukkan Username">
        </div>

        <div class="mb-3 w-75">
          <label for="exampleFormControlInput3" class="form-label">Password</label>
          <input type="password" class="form-control" name="passwordadmin" id="exampleFormControlInput3" placeholder="Masukkan Password">
        </div>
