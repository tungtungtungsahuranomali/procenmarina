...
$takedatagroup = "SELECT * FROM about WHERE id_about = '$getidhotel'";
$connettakedatagroup = mysqli_query($koneksi, $takedatagroup);
while($takedata = mysqli_fetch_array($connettakedatagroup)){
...
if(isset($_POST['submit'])){
  $judulgroup = $_POST['judulgroup'];
  $deskripsigroup = $_POST['deskripsigroup'];
  $gambargroup = $_FILES['gambargroup']['name'];
  $targetpath = "images/picabout/";
  $path = $targetpath.basename($gambargroup);
  $tmpgambar = $_FILES['gambargroup']['tmp_name'];
        ...
        <h2 class="mb-4"><?php echo $namahotel; ?><Title></Title></h2>
         ...
         <form method="POST" enctype="multipart/form-data">
          <div class="mb-3 w-75">
            ...
            <input type="text" class="form-control" name="judulgroup" id="exampleFormControlInput2" value ="<?php echo $judulabout; ?>">
          </div>
          ...
          <div class="mb-3 w-75" style="display: flex; align-items: center;">
            ...
            <textarea name="deskripsigroup" style="width: 450px; height: 200px;"><?php echo $deskripsiabout; ?></textarea>
          </div>

          <div style="display: flex; flex-direction: column;">
            <input type="file" name="gambargroup">
