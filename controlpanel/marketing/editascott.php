...
$takedatatauzia = "SELECT * FROM about WHERE id_about = '$getidhotel'";
$connettakedatatauzia = mysqli_query($koneksi, $takedatatauzia);
while($takedata = mysqli_fetch_array($connettakedatatauzia)){
...
if(isset($_POST['submit'])){
  $judultauzia = $_POST['judultauzia'];
  $deskripsitauzia = $_POST['deskripsitauzia'];
  $gambartauzia = $_FILES['gambartauzia']['name'];
  ...
  if(!empty(trim($judultauzia))){
    if(!empty(trim($deskripsitauzia))){
      if(move_uploaded_file($tmpgambar, $path)){
        $insertdata = "UPDATE about set judul_about = '$judultauzia', deskripsi_about = '$deskripsitauzia', gambar_about = 'http://172.31.15.253/controlpanel/images/picabout/$gambartauzia' WHERE id_about = '$getidhotel'";
        ...
        <h2 class="mb-4"><?php echo $namahotel; ?><Title></Title></h2>
         ...
         <form method="POST" enctype="multipart/form-data">
          <div class="mb-3 w-75">
            ...
            <input type="text" class="form-control" name="judultauzia" id="exampleFormControlInput2" value ="<?php echo $judulabout; ?>">
          </div>
          ...
          <div class="mb-3 w-75" style="display: flex; align-items: center;">
            ...
            <textarea name="deskripsitauzia" style="width: 450px; height: 200px;"><?php echo $deskripsiabout; ?></textarea>
          </div>
