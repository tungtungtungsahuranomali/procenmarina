...
$datafasilitas = "SELECT * FROM fasilitas";
$connectdatafasilitas = mysqli_query($koneksi, $datafasilitas);
...
if(isset($_POST['submit'])){
  ...
  $insert = "INSERT INTO fasilitas set judul_gambar = '$gambar', gambar = 'http://172.31.15.253/controlpanel/images/picfasilitas/$gambar', kategori = '$kategori'";
    ...
    if($usersession){
      ...
      <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5">
          ...
          <h2 class="mb-4">Fasilitas<Title></Title></h2>
          <p>Insert pic</p>
          ...
          <div class="table-responsive w-75">
            <table class="table table-striped custom-table">
              ...
              <tbody>
                ...
                if(mysqli_num_rows($connectdatafasilitas)){
                  while($takedatafasilitas = mysqli_fetch_array($connectdatafasilitas)){
                    $idfasilitas = $takedatafasilitas['id_gambar'];
                    $judulgambar = $takedatafasilitas['judul_gambar'];
                    $kategorifasilitas = $takedatafasilitas['kategori'];
                    $linkgambar = $takedatafasilitas['gambar'];
                    ?>
                    <tr scope="row">
