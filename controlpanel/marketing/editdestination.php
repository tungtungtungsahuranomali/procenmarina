...
$getiddestination = $_GET['iddestination'];

$takedatadestination = "SELECT * FROM information WHERE id_information = '$getiddestination'";
$connettakedatadestination = mysqli_query($koneksi, $takedatadestination);
while($takedata = mysqli_fetch_array($connettakedatadestination)){
  $juduldestination = $takedata['judul'];
  $deskripsidestination = $takedata['deskripsi'];
  //$gambaremergency = $takedata['gambar'];
  $kategoridestination = $takedata['kategori'];
}

if(isset($_POST['submit'])){
  $juduldestination1 = $_POST['juduldestination'];
  $deskripsidestination1 = $_POST['deskripsidestination'];
  ...
  if(!empty(trim($juduldestination1))){
    if(!empty(trim($deskripsidestination1))){

        if($connettakedatadestination){
          $insertdata = "UPDATE information set judul = '$juduldestination1', deskripsi = '$deskripsidestination1' WHERE id_information = '$getiddestination'";
  ...
  if($usersession){
    ...
    <div class="wrapper d-flex align-items-stretch">
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <h2 class="mb-4"><?php echo $juduldestination; ?><Title></Title></h2>

         <form method="POST" enctype="multipart/form-data">
          <div class="mb-3 w-75">
            <label for="exampleFormControlInput2" class="form-label">Judul</label>
            <input type="text" class="form-control" name="juduldestination" id="exampleFormControlInput2" value ="<?php echo $juduldestination; ?>">
          </div>
          ...
          <div class="mb-3 w-75" style="display: flex; align-items: center;">
            ...
            <textarea name="deskripsidestination" style="width: 450px; height: 200px;"><?php echo $deskripsidestination; ?></textarea>
          </div>
