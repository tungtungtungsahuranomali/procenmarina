...
if(isset($_POST['submit'])){
  ...
  $insert = "INSERT INTO reflexology set link_gambar = 'http://172.31.15.253/controlpanel/images/picreflexology/$gambar', judul_gambar = '$judulgambar'";
  $connectinsert = mysqli_query($koneksi, $insert);
  if(!empty($gambar)){
    if(move_uploaded_file($storage, "../images/picreflexology/".$gambar)){
  ...
  <body>
    ...
    if($usersession){
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <script type="text/javascript">
          function back(){
            window.location.href = "reflexology.php";
          }
