...
//get id tv
$idtvget = $_GET['iddevice'];

//take data tv
$datatv = "SELECT * FROM tv WHERE id_tv = '$idtvget'";
$connectdatatv = mysqli_query($koneksi, $datatv);
while($takedatatv = mysqli_fetch_array($connectdatatv)){
  $idtvdb = $takedatatv['id_tv'];
  $macaddressdb = $takedatatv['mac_address'];
  $roomnamedb = $takedatatv['room_name'];
}
...
if(isset($_POST['submit'])){
  ...
  // insert device
  $changedevice = "UPDATE tv set mac_address = '$macaddress', room_name = '$roomname'";
  $connectchangedevice = mysqli_query($koneksi, $changedevice);
  if($connectchangedevice){
    ...
    <div class="wrapper d-flex align-items-stretch">
      <nav id="sidebar" class="active">
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li>
            <a href="Television-list.php"><span class="fa fa-tv"></span>Television</a>
          </li>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <h2 class="mb-4">Change device<Title></Title></h2>

         <form method="POST">
          <div style="display: flex; flex-direction: column;">
            <div class="mb-3 w-75">
              <label for="exampleFormControlInput2" class="form-label" style="color: black; font-weight: bolder;">MAC address</label>
              <input type="text" class="form-control" name="macaddress" id="exampleFormControlInput2" placeholder="<?php echo $macaddressdb; ?>">
            </div>
            <div>
              current mac address : <span style="color: red;"><?php echo $macaddressdb; ?></span>
            </div>
          </div>

          <div style="display: flex; flex-direction: column;">
            <div class="mb-3 w-75">
              <label for="exampleFormControlInput3" class="form-label" style="color: black; font-weight: bolder;">Room name</label>
              <input type="text" class="form-control" name="roomname" id="exampleFormControlInput3" placeholder="<?php echo $roomnamedb ?>">
            </div>
            <div>
              current room name : <span style="color: red;"><?php echo $roomnamedb; ?></span>
            </div>
          </div>
