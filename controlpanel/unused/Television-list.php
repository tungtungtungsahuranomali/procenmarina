  ...
  if($usersession){
    ...
    <div class="wrapper d-flex align-items-stretch">
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <h2 class="mb-4">Television List<Title></Title></h2>
        <a class="btn" href="adddevice.php" role="button" style="background-color: blue; color: white; font-weight: bolder;">Add Device</a>
        <div class="table-responsive w-75">
          <table class="table table-striped custom-table">
            ...
            <tbody>
              ...
              if(mysqli_num_rows($connectdatatv)){
                while($takedatadv = mysqli_fetch_array($connectdatatv)){
                  $idtv = $takedatadv['id_tv'];
                  $macaddress = $takedatadv['mac_address'];
                  $roomname = $takedatadv['room_name'];
                  ?>
                   <tr scope="row">
                    <td><?php echo $idtv; ?></td>
                    <td class="pl-0">
                      <div class="d-flex align-items-center">
                        <a href="#" class="mac_address"><?php echo $macaddress; ?></a>
                      </div>
                    </td>
                    <td><?php echo $roomname; ?></td>
                    <td>
                      <a class="edit btn" href="changedevice.php?iddevice=<?php echo $idtv; ?>" style="background-color: blue; color: white; font-weight: bolder;">Change</a>
                    </td>
                  </tr>
                <?php 
                }
