...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <h2 class="mb-4">Edit Television<Title></Title></h2>
        <div class="mb-3 w-75">
          <label for="exampleFormControlInput1" class="form-label">Room Name</label>
          <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Room Name">
        </div>
        <div class="mb-3 w-75">
          <label for="exampleFormControlInput1" class="form-label">MAC Address</label>
          <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Format : xx:xx:xx:xx:xx:xx">
        </div>
        <br>
