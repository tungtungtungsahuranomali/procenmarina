...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <h2 class="mb-4">Image Slider List<Title></Title></h2>
        <a class="btn btn-primary" href="#" role="button">Add Image</a>
              ...
              <tr scope="row">
                ...
                <td class="pl-0">
                  <div class="d-flex align-items-center">
                    <a href="#" class="mac_address"> Image 1</a>
                  </div>
                </td>
                <td>
                  <a class="edit btn btn-outline-primary" href="#">Edit</a>
