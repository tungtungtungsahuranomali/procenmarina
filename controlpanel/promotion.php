...
$datapromotion = "SELECT * FROM promotion";
$connectdatapromotion = mysqli_query($koneksi, $datapromotion);
    ...
    if($usersession){
      ...
      <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5">
          ...
          <h2 class="mb-4">Promotion<Title></Title></h2>
          <a class="btn" href="addpromotion.php" role="button" style="background-color: blue; color: white; font-weight: bolder;">Tambah Gambar</a>
          ...
          <div class="table-responsive w-75">
            <table class="table table-striped custom-table">
              ...
              <tbody>
                <?php 
                if(mysqli_num_rows($connectdatapromotion)){
                  while($takedatapromotion = mysqli_fetch_array($connectdatapromotion)){
